...
软件工程在读，写 Java 也写 Python。喜欢把学到的东西做成项目——手写框架、时间管理工具、微服务治理、AI 应用原型，都在这里。

> **专注** · `Java 后端` `Spring 生态` `分布式系统`
> **学习中** · `Agent 工程化` `RAG` `向量数据库` `可观测性`
> **信条** · `可读的代码` `务实的架构` `持续迭代`
...
- **微服务工程** — Spring Cloud 全家桶、链路追踪、服务治理，把分布式系统跑通、跑稳。
- **AI 应用基础设施** — RAG 工作流、Tool Calling、MCP、向量检索，让 Agent 真正可用。
- **工程基本功** — 手写框架理解原理，写测试守住边界，部署流程自动化。
- **技术写作** — CSDN 和掘金持续输出，把笔记变成可运行的 Demo。

## 代表项目

> 从零构建的项目，每个都踩过坑、学到过东西。
...
[![CSDN](https://img.shields.io/badge/CSDN-%E6%8A%80%E6%9C%AF%E7%AC%94%E8%AE%B0-FC5531?style=for-the-badge&logo=csdn&logoColor=white)](https://blog.csdn.net/2402_89042144?spm=1000.2115.3001.5343)
